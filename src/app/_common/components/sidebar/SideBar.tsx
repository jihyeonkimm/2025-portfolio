  ...
  return (
    <S.SideBarContainer $show={activeSection === 'about' || activeSection === 'projects'}>
      <S.SideBarLink href='mailto:jh418531@gmail.com'>
        mail
        <Image src='/assets/images/icon/icon-mail.svg' alt='github logo' width='20' height='20' />
        <S.SideBarTooltip>Mail</S.SideBarTooltip>
      </S.SideBarLink>
      <S.SideBarLink href='/assets/file/jihyeonkim-cv.pdf' download target='_blank'>
        CV
        <Image src='/assets/images/icon/icon-cv.svg' alt='github logo' width='20' height='20' />
        <S.SideBarTooltip>CV</S.SideBarTooltip>
      </S.SideBarLink>
      <S.SideBarLink href='https://jh-log.tistory.com/' target='_blank'>
        blog
        <Image src='/assets/images/icon/icon-blog.svg' alt='github logo' width='20' height='20' />
